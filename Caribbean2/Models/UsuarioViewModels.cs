...
public class UsuarioViewModel
{
    ...
    [RegularExpression("^[0-9]{6,15}$", ErrorMessage = "El número de identificación debe ser numérico y tener entre 6 y 15 dígitos.")]
    ...
    [RegularExpression(@"^[a-zA-Z0-9!@#$%^&*()_+=-]{8,15}$", 
        ErrorMessage = "La contraseña debe contener letras, números y caracteres especiales permitidos.")]
    ...
    [RegularExpression(@"^[a-zA-Z0-9]{5,}@[a-zA-Z0-9.-]+\.com$", ErrorMessage = "El correo debe ser válido, tener al menos 5 caracteres antes del @ y terminar en .com, sin caracteres especiales.")]
